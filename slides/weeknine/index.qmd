...
```{mermaid}
%%| echo: false
%%| fig-cap: "A linked list with three data-containing nodes"
%%| scale: 200
graph LR
...
- Create a revised `LinkedList` that moves both directions
...
## Concerns about `LinkedListQueue`?
