...
%%| fig-width: 18
graph LR
    Head["_head"] --> Node1["Node1<br>data: 42"]
    Node1 --> Node2["Node2<br>data: 17"]
    Node2 --> Node3["Node3<br>data: 99"]
    Node3 --> Null["None"]
...
- The `None` reference marks the end of the linked list
- Adding or removing nodes only changes the `link` pointers!
...
::: {.fragment style="font-size: 0.9em; margin-top: -0.2em"}
