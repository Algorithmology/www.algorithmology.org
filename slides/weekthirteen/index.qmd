...
## Let's start with a complete implementation of the tree!
...
- The `Tree` will build on the `Queue` class
...
## Traversing and Printing a Tree
...
- Print the starting node and then traverse the children
- Continue this process until all nodes were displayed

## Using an Iterator in Tree Traversal
