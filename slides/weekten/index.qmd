...
You can use this function to find the length of the longest common subsequence between two strings. For example, `lcs('ABCBDAB', 'BDCAB')` would return `4`, which is the length of the longest common subsequence ('BCAB').
