...
performance
- Tools: Install and use `python`, `mise`, `asdf`, `devenv`, and `poetry`
...
- **Algorithm All-Hands Projects**:
  ...
  - Use `git` GitHub flow on the course web site's repository
  - Use `quarto` to render a preview of the course web site
  - Use the Quarto VS Code extension to run code segments
- **Confirm operation with the instructor and technical leader!**
