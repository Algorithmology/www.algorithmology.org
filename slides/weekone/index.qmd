...
{{< iconify fa6-solid microscope >}} How do we *characterize* the execution
environment of these programs? *...* How do we *compare* their performance in
...
performance
- Tools: `python`, `mise`, `asdf`, `devenv`, and `poetry`
...
::: {.fragment .fade style="margin-top: 0.0em; font-size: 0.925em;"}
