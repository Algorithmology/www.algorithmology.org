...
input size doubles, the time quadruples. To learn more about this topic, you can
use the technical content in the course to learn how to analyze the time
complexity of algorithms --- so check out the [schedule](schedule/index.qmd) and
the [slides](slides/index.qmd) for more details!
...
- The [](./allhands/index.qmd) includes articles written by learners as they
explore the engineering and scientific knowledge and skills in the field of
algorithmology. While some of the articles you read report on the results from
running experiments, others explain how to implement and use the Python source
code that supports performance benchmarking. Read these reports to learn more
about the analysis of algorithms!
