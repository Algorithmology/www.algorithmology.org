...
[slides](slides/index.qmd) for this course as provided by this site.

## Wow, Python Source Code ... and its Output!

As you browse the resources on this site you will notice that they often contains
...
function will produce a data table that reveals that the likely worst-case time
complexity of `duplicates` is $O(n^2)$.
