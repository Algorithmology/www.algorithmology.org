...
objectives for the Computer Science major:
...
As indicated above, the learning objectives for Computer Science 202 enable to
attainment of the CS program learning objectives that in turn support the
attainment of the College's learning objectives.

### Course Textbooks

- {{< iconify fa6-solid book-open >}} [A First Course on
Data Structures in Python](https://donsheehy.github.io/datastructures/)

- {{< iconify fa6-brands github >}} The `ds2` package in
[donsheehy/datastructures](https://github.com/donsheehy/datastructures) book and
package code
...
actively participate in all of the class and laboratory sessions. After either
an unexcused absence or a late attendance to either a class or a laboratory
session, a student's weekly class participation grade will be reduced. Students
who need to miss class or attend class late for an excused reason should
communicate their situation to the instructor in a timely fashion. After one
warning per week, a student's weekly class participation grade will be reduced
if they are observed undertaking non-course-related activities like viewing
...
cumulative assessments covering all prior material from the course sessions, as
...
request the reassessment of work that you completed for this course. For
instance, a student may choose to spend a token by asking the course instructor
to reevaluate one of the algorithm engineering projects. Outside of these five
tokens, the instructor will not consider any additional requests for deadline
extensions or assignment reassessment.
