...
students will collaboratively complete and present an analytical and empirical
evaluation of the performance of one component of an executable examination.
...
effort* in the field of algorithm analysis, students will complete and present a
...
Classroom, and/or the [Algorithmology
Discord](https://discord.gg/YHjhQaBnme). All reflections on and documentation of
...
to assess (e.g., the work for an algorithm engineering project) must be in a
GitHub repository.
