...
From the results of running the second version of sum_stop_int_2, it could be seen that the trend is a polynomial trendline, where as the input increases, the time will decrease until it reaches the lowest optimum input, which is around 11250000. As it reaches this point, the time will increase as the input also increases. 
