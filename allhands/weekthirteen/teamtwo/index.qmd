...
def double_ratio(execution_times: List[float]) -> float: 
    ...
    if len(execution_times) > 2:
        ...
        if n < 1:
            print(f"The ratio was {n} which rounds to {n_rounded} which means that the worst-case time complexity is Constant or better!")
...
![Selection Sort Graph](../teamtwo/images/selection_sort_graph.png)
