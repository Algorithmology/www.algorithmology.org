...
it took around 0.067 seconds on average to do 10 runs in 3 benchmark trials. The total time
for all three trials was 0.670 and 0.680 seconds. THe second test, where there were added
duplicate numbers took about 0.0016 seconds. Efficiently eliminating duplicates,
accomplished through the transformation of a list into a set, emerges as a valuable tactic
to enhance the performance of containment checking. These findings demonstrate the
significance of contemplating data preprocessing steps, including duplicate removal, when
crafting algorithms for applications requiring frequent containment checks in extensive
datasets. 
