...
Our team hypothesize that if a large container values is affected from a large
number of duplicates, it will affect the containment checking. The independent
